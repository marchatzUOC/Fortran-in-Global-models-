...
!REAL(KIND=JPRB), PARAMETER                 :: u1fac=0.8    ! 0.7 in EC-Earth 3.2.3
...
!INTEGER(KIND=JPIM) :: IDUST,KK,KKK,KFIRST,KKMIN
...
!REAL(KIND=JPRB)    :: FPAR(KLON,12)        ! Local copy of 
...
!WRITE(NULOUT,*) 'NOMINERALS = ', NOMINERALS
